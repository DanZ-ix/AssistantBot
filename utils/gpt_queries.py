...
10. Показать напоминания:
   ...
   - Если пользователь хочет получить все напоминания, верни result: null.
11. Пользователь спрашивает, что ты умеешь:
   Формат: {"action": "get_actions", "result": "Все что ты умеешь из этого промта, кроме пункта 11, в виде строки"}
'''
